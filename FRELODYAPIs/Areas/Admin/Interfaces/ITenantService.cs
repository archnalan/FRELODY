...
namespace FRELODYAPIs.Areas.Admin.Interfaces
{
    public interface ITenantService
    {
        ...
        /// <summary>Finalizes username + password for a user that registered without an organization.</summary>
        Task<ServiceResult<bool>> CompleteUserRegistration(CompleteUserRegistrationDto dto);
