...
namespace FRELODYLIB.Migrations
{
    ...
    [Migration("20260626070555_GeneralizeSongPlayHistoryForDiscover")]
    partial class GeneralizeSongPlayHistoryForDiscover
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FRELODYAPP.Models.ChordChart", b =>
                {
                    ...
                    b.Property<string>("ChordDataJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RenderedPngPath")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.FeedbackReply", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.SeedVersion", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.SubModels.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("BillingExpiresAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.TikTokTranscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ChordDict")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("ChordModel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("SyncedChordsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float>("TotalProcessingSeconds")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("VideoId", "BeatModel", "ChordModel", "ChordDict")
                        .IsUnique();

                    b.ToTable("TikTokTranscriptions");
                });

            modelBuilder.Entity("FRELODYAPP.Models.TikTokVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.YouTubeTranscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("YouTubeTranscriptions");
                });

            modelBuilder.Entity("FRELODYAPP.Models.YouTubeVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRELODYLIB.Models.AnalysisRequestLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("Platform", "VideoId", "UserId", "RequestDate")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL");

                    b.ToTable("AnalysisRequestLogs");
                });

            modelBuilder.Entity("FRELODYLIB.Models.AnalyzedSongUnlock", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("UserId", "Platform", "VideoId", "UnlockedAt");

                    b.ToTable("AnalyzedSongUnlocks");
                });

            modelBuilder.Entity("FRELODYLIB.Models.AnalyzedVideoWhitelist", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("AnalyzedVideoWhitelists");
                });
            ...
            modelBuilder.Entity("FRELODYLIB.Models.EmailOtpVerification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FRELODYLIB.Models.Playlist", b =>
                {
                    ...
                    b.Property<int>("GlobalTranspose")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRELODYAPP.Models.FeedbackReply", b =>
                {
                    b.HasOne("FRELODYAPP.Models.UserFeedback", "Feedback")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("FRELODYAPP.Models.TikTokTranscription", b =>
                {
                    b.HasOne("FRELODYAPP.Models.TikTokVideo", "Video")
            ...
            modelBuilder.Entity("FRELODYAPP.Models.YouTubeTranscription", b =>
                {
                    b.HasOne("FRELODYAPP.Models.YouTubeVideo", "Video")
                        .WithMany("Transcriptions")
                        .HasForeignKey("VideoId")
                        .HasPrincipalKey("VideoId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("FRELODYLIB.Models.ShareLink", b =>
                {
                    b.HasOne("FRELODYLIB.Models.Playlist", "Playlist")
                        .WithMany()
                        .HasForeignKey("PlaylistId");
