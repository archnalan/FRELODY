...
namespace FRELODYLIB.Migrations
{
    ...
    [Migration("20251019134313_SongUserCollections")]
    partial class SongUserCollections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FRELODYLIB.Models.SongCollection", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FRELODYLIB.Models.SongUserCollection", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SongCollectionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("SongCollectionId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SongCollectionId1");

                    b.HasIndex("TenantId");

                    b.HasIndex("SongId", "SongCollectionId", "TenantId")
                        .IsUnique()
                        .HasFilter("[TenantId] IS NOT NULL");

                    b.ToTable("SongUserCollections");
                });
            ...
            modelBuilder.Entity("FRELODYAPP.Models.SongBook", b =>
                {
                    b.HasOne("FRELODYLIB.Models.SongCollection", "Collection")
                        .WithMany("SongBooks")
            ...
            modelBuilder.Entity("FRELODYLIB.Models.SongUserCollection", b =>
                {
                    b.HasOne("FRELODYLIB.Models.SongCollection", "SongCollection")
                        .WithMany()
                        .HasForeignKey("SongCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FRELODYLIB.Models.SongCollection", null)
                        .WithMany("SongCollections")
                        .HasForeignKey("SongCollectionId1");
